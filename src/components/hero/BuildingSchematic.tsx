    ...
    >
      ...
      <defs>
        <pattern id="bimGrid" width="24" height="24" patternUnits="userSpaceOnUse">
          <path d="M24 0H0V24" fill="none" stroke={colors.neutral[300]} strokeWidth="0.45" opacity="0.36" />
          <circle cx="0" cy="0" r="0.7" fill={colors.neutral[400]} opacity="0.34" />
        </pattern>
        <pattern id="concreteHatch" width="7" height="7" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
          <line x1="0" y1="0" x2="0" y2="7" stroke={colors.neutral[500]} strokeWidth="0.55" opacity="0.34" />
        </pattern>
        <pattern id="concreteStipple" width="12" height="12" patternUnits="userSpaceOnUse">
          <circle cx="2" cy="3" r="0.55" fill={colors.neutral[500]} opacity="0.3" />
          <circle cx="9" cy="8" r="0.45" fill={colors.neutral[500]} opacity="0.22" />
        </pattern>
        <style>{`
      ...
      <rect x="15" y="15" width="570" height="570" rx="8" fill="none" stroke={colors.neutral[200]} className="dark:stroke-neutral-800" opacity="0.65" />
      <g fill="none" stroke={colors.neutral[400]} strokeWidth="0.55" strokeDasharray="4 5" className="dark:stroke-neutral-700" opacity="0.32">
      ...
      <g fill="none" stroke={colors.neutral[400]} strokeWidth="0.7" className="dark:stroke-neutral-700" opacity="0.42">
      ...
      <g stroke={colors.neutral[500]} fill="none" className="dark:stroke-neutral-600 bim-transition" opacity="0.76">
        <g strokeWidth="1.3">
      ...
      <g stroke={colors.neutral[600]} fill="none" className="dark:stroke-neutral-500 bim-transition" opacity="0.76" strokeLinejoin="round">
      ...
      <g stroke={systemStroke} fill="none" className="bim-transition dark:stroke-neutral-600" opacity={securityActive || networkActive || sapActive ? 0.98 : 0.7}>
        <g strokeWidth={securityActive || networkActive || sapActive ? 1.45 : 1.05}>
          ...
          <polygon points="300,120 352,90 300,60 248,90" fill={colors.background.muted} className="dark:fill-neutral-900" opacity="0.42" />
        ...
        <g stroke={colors.neutral[600]} strokeWidth="0.7" opacity="0.84">
      ...
      <g stroke={hvacActive ? SYSTEM_COLORS.hvac : colors.neutral[500]} fill="none" className="bim-transition dark:stroke-neutral-600" opacity={hvacActive ? 1 : 0.44}>
        ...
        <g className={hvacActive ? "fan-active" : ""} strokeWidth="0.95">
          <polygon points="350,151 380,134 364,125 334,142" fill={colors.background.surface} className="dark:fill-neutral-900" />
        ...
        <g strokeWidth="0.75">
          <polygon points="394,128 424,111 408,102 378,119" fill={colors.background.surface} className="dark:fill-neutral-900" />
